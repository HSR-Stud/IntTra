%TODO 1: hier und am Schluss von diesem Abschnitt müsste die globale Einstellung, bezüglich des Abstandes nach einer Section ausgesetzt werden und lokal verändert werden. Ansonsten muss bei jeder Änderung dieses Abschnitts die \vspaces manuell ausprobiert werden. Sehr unschöner Code!!

\section{Fourier-Transformation \skript{17}}%
	\subsection{Bedingung Existenz}%
		\vspace{-3mm}	%TODO 1: siehe TODO1 (oben)
	...
	\subsection{Berechnungen \skript{21}}%
		\vspace{-2mm}	%TODO 1: siehe TODO1 (oben)
		...
		\subsection{Eigenschaften \skript{29}}
